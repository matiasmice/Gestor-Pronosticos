...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="text-end"><span class="auto-style7">&nbsp;&nbsp;&nbsp;
                ...
                <asp:Button ID="btnEditar" runat="server" CssClass="auto-style5" Text="Editar" OnClick="btnEditar_Click" />
            <span class="auto-style7">&nbsp;&nbsp;</span><asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="auto-style7" OnClick="btnEliminar_Click" />
            <span class="auto-style7">&nbsp;<asp:Button ID="btnCrear" runat="server" Text="Crear" OnClick="BtnCrear_Click" />
            &nbsp;</span></td>
    </tr>
    <tr>
